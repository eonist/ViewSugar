...
extension UIView {
    ...
    public func color(point: CGPoint) -> UIColor {
        ...
        let red: CGFloat = .init(pixelData[0]) / CGFloat(255.0)
        let green: CGFloat = .init(pixelData[1]) / CGFloat(255.0)
        let blue: CGFloat = .init(pixelData[2]) / CGFloat(255.0)
        let alpha: CGFloat = .init(pixelData[3]) / CGFloat(255.0)
