...
//   private var hasHandCursor: Bool = false // Fixme: ⚠️️ Consider removing this, its clutters up the method, add handCursor flag in subClass when needed
   /*this can probably be removed--->*/override var wantsDefaultClipping: Bool { false }/*<--yepp remove this, once more UI components are tested*///avoids clipping the view, so dont remove?
...
//   }
    ...
    * - Fixme: ⚠️️ When you implement propegation of the mouseMove method, mouseMove needs a bool to turn it on or it will flood its parents with calls, isMouseMovable could be used
    */
